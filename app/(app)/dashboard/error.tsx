...
// Route: /dashboard — 에러 바운더리
// Next.js App Router 요구사항: error.tsx는 반드시 "use client"
// props: error(에러 객체, digest 포함), reset(재시도 콜백)
  ...
  return (
    ...
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 text-center">
      <div className="space-y-2">
        <h2 className="text-lg font-semibold">구독 목록을 불러오지 못했습니다</h2>
        <p className="text-sm text-muted-foreground">
          잠시 후 다시 시도해 주세요.
          {/* digest: Vercel 서버 로그와 대조할 수 있는 에러 식별자 */}
          {error.digest && (
